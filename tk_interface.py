...
class TkFileDialogExample(tkinter.Frame):
  ...
  def __init__(self, root):
    ...
    lab2 = Label(root, text="Выберите язык", font="Arial 18")
    lab2.pack()

    self.lang = IntVar()
    rbutton1 = Radiobutton(root, text='русский', variable=self.lang, value='1')
    rbutton2 = Radiobutton(root, text='английский', variable=self.lang, value='2')
    rbutton3 = Radiobutton(root, text='немецкий', variable=self.lang, value='3')
    rbutton1.pack()
    rbutton2.pack()
    rbutton3.pack()
    ...
    lab1 = Label(root, text="Введите первое прилагательное", font="Arial 18")
    lab1.pack()

    self.adj1 = Entry(root, width=20, bd=3)
    self.adj1.pack()

    lab11 = Label(root, text="Введите основу первого прилагательного", font="Arial 18")
    lab11.pack()

    self.osnova1 = Entry(root, width=20, bd=3)
    self.osnova1.pack()

    ######

    lab2 = Label(root, text="Введите второе прилагательное", font="Arial 18")
    lab2.pack()

    self.adj2 = Entry(root, width=20, bd=3)
    self.adj2.pack()

    lab22 = Label(root, text="Введите основу второго прилагательного", font="Arial 18")
    lab22.pack()

    self.osnova2 = Entry(root, width=20, bd=3)
    self.osnova2.pack()

    ######

    lab4 = Label(root, text="Что вы хотите сделать?", font="Arial 18")
    lab4.pack()

    self.var1 = IntVar()
    self.var2 = IntVar()
    self.check1 = Checkbutton(root, text=u'Построить таблицы', variable=self.var1, onvalue=1, offvalue=0)
    self.check2 = Checkbutton(root, text=u'Нарисовать график', variable=self.var2, onvalue=1, offvalue=0)
    self.check1.pack()
    self.check2.pack()

    ######

    labtr = Label(root, text="Сделать перевод? (для английского и немецкого)", font="Arial 18")
    labtr.pack()

    self.tr = IntVar()
    rbutton_yes = Radiobutton(root, text='да', variable=self.tr, value='1')
    rbutton_no = Radiobutton(root, text='нет', variable=self.tr, value='0')
    rbutton_yes.pack()
    rbutton_no.pack()
    ...
    self.first = Button(self, text='Выберите файл с первым прилагательным', command=self.askopenfilename_first)
    self.second = Button(self, text='Выберите файл со вторым прилагательным', command=self.askopenfilename_second)
    self.mst = Button(self, text='Введите путь к программе mystem', command=self.askopenfilename_mst)
    self.trtg = Button(self, text='Введите путь к программе TreeTagger', command=self.askopenfilename_trtg)
    ...
    self.button_final = Button(text="Поехали!", command=self.Pressed)
  ...
  def Pressed(self):  # function
      ...
      answers['language'] = self.lang.get()
